...
import Hand_holding_phone from "../../../common/images/Hand_Phone.png";
      ...
      <div className="flex flex-col items-start w-full max-w-xl px-4 mx-auto lg:px-8 lg:max-w-screen-xl">
        <div className="mb-16 lg:my-40  lg:pr-5">
          <div className="max-w-xl mb-6">
            <div>
              <p className="inline-block py-px mb-4 text-xs font-semibold tracking-wider text-primaryOne uppercase rounded-full bg-teal-accent-400">
                Launching soon
              </p>
            </div>
