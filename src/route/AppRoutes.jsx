...
import { WelcomePage, Dashboard, Waitlist, ThankYou } from "../pages";
    ...
    <Router history={history}>
      <Routes>
        ...
        {/* <Route
          ...
          element={
            <RouteWithLayout redirectTo={Non_AuthRoutes.waitlist}>
              <PlainLayout>
                <Dashboard />
              </PlainLayout>
            </RouteWithLayout>
